      ...
      <div className="row mx-0">
        <div className="col-12 col-md-6 col-xl-4 px-0">
          <HoverVideoPlayer
            ...
            pausedOverlay={<img src={Place1} alt="" className="hoverd-video" />}
            loadingOverlay={
        ...
        <div className="col-12 col-md-6 col-xl-4 px-0">
          <HoverVideoPlayer
            ...
            className="video-gallery"
            pausedOverlay={<img src={Place2} alt="" className="hoverd-video" />}
            loadingOverlay={
              <div className="loading-overlay">
                <div className="loading-spinner" />
              </div>
        ...
        <div className="col-12 col-md-12 col-xl-4 px-0">
          <HoverVideoPlayer
            ...
            className="video-gallery"
            pausedOverlay={<img src={Place3} alt="" className="hoverd-video" />}
            loadingOverlay={
              <div className="loading-overlay">
                <div className="loading-spinner" />
              </div>
      ...
      <div className="row mx-0">
        <div className="col-12 col-md-6 col-xl-6 px-0">
          <HoverVideoPlayer
            ...
            className="video-gallery"
            pausedOverlay={<img src={Place4} alt="" className="hoverd-video" />}
            loadingOverlay={
              <div className="loading-overlay">
                <div className="loading-spinner" />
              </div>
        ...
        <div className="col-12 col-md-6 col-xl-6 px-0">
          <HoverVideoPlayer
            ...
            className="video-gallery"
            pausedOverlay={<img alt="" src={Place5} className="hoverd-video" />}
            loadingOverlay={
              <div className="loading-overlay">
                <div className="loading-spinner" />
              </div>
